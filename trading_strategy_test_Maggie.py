...
class Strategy:
    ...
    def fit(self, original):
        ...
        self.z_score.append(price_update['zscore'])
        ...
        if len(self.price) > 40:
            predict_value = self.model.predict(
                [[price_update['Open'] - price_update['Close'], price_update['High'] - price_update['Low'],
                  ...
                  price_update['Return'], price_update['volume change_pct'], price_update['upper_band'],
                  price_update['lower_band'], price_update['zscore']]])
